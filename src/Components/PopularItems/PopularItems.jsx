...
import pr1 from './../../../images/pr1.jfif'
import pr2 from './../../../images/pr2.jfif'
import pr3 from './../../../images/pr3.jfif'
import pr4 from './../../../images/pr4.jfif'
import pz1 from './../../../images/pz1.jfif'
import pz2 from './../../../images/pz2.jfif'
  ...
  return (
    <div className="Popular">
      ...
      <h1 className="poppins-bold" style={{ color: "#3F3F3F" }}>
        Our Popular <span style={{ color: "#F72D57" }}>Categories</span>
      </h1>
      
      </div>
      {/* Category Button Section */}
      <div style={{ display: "flex" }} className="poppins-regular category-hovering">
        <div className="full-hover1">
          <button className="hover-buttons1">
            <svg
              width="38"
              height="40"
              viewBox="0 0 38 40"
            ...
            >
              <path
                d="M32.1181 7.85635C27.8817 6.13042 23.4363 5.38342 18.5334 5.38342C13.6304 5.38342 8.84437 6.2053 4.93589 7.81983C4.19803 8.12118 3.54236 8.6417 4.01631 9.60056C4.40076 10.3795 13.6934 30.8616 17.2238 38.1671C17.3428 38.4139 17.5289 38.6221 17.7609 38.7679C17.9929 38.9136 18.2612 38.9909 18.5352 38.9909C18.8091 38.9909 19.0775 38.9136 19.3095 38.7679C19.5415 38.6221 19.7276 38.4139 19.8465 38.1671L33.0011 9.65535C33.2924 9.02524 33.0833 8.24903 32.1181 7.85635V7.85635Z"
                stroke="white"
                stroke-width="2"
                stroke-miterlimit="10"
              />
              <path
                d="M35.0056 4.16696C30.2506 2.28578 24.3934 1 18.5334 1C12.6734 1 6.90385 2.16706 2.04839 4.11217C1.6201 4.2875 0.817403 4.69205 1.03748 5.37238L1.92146 7.575C2.28673 8.32382 2.7132 8.32382 3.29673 8.32382C3.46019 8.32382 3.68849 8.2325 3.96153 8.12475C8.60813 6.3199 13.5486 5.39045 18.5334 5.38334C23.7167 5.38334 29.0269 6.47917 33.108 8.12292C33.4358 8.25077 33.6184 8.322 33.7728 8.322C34.3737 8.322 34.7207 8.52199 35.1426 7.58231L36.0348 5.38334C36.2183 4.83542 35.5791 4.39526 35.0056 4.16696Z"
                stroke="white"
                stroke-width="2"
                stroke-miterlimit="10"
              />
              <path
                d="M12.6889 17.0722C14.3028 17.0722 15.6111 15.7639 15.6111 14.15C15.6111 12.5361 14.3028 11.2278 12.6889 11.2278C11.075 11.2278 9.76669 12.5361 9.76669 14.15C9.76669 15.7639 11.075 17.0722 12.6889 17.0722Z"
                fill="white"
              />
              <path
                d="M24.3778 18.5334C25.9917 18.5334 27.3 17.2251 27.3 15.6112C27.3 13.9973 25.9917 12.689 24.3778 12.689C22.7639 12.689 21.4555 13.9973 21.4555 15.6112C21.4555 17.2251 22.7639 18.5334 24.3778 18.5334Z"
                fill="white"
              />
              <path
                d="M18.5333 28.7611C20.1472 28.7611 21.4556 27.4528 21.4556 25.8389C21.4556 24.225 20.1472 22.9167 18.5333 22.9167C16.9194 22.9167 15.6111 24.225 15.6111 25.8389C15.6111 27.4528 16.9194 28.7611 18.5333 28.7611Z"
                fill="white"
              />
            </svg>
        ...
        <div className="full-hover">
          <button className="hover-buttons">
            ...
            >
              ...
              />
              <path
                d="M18.5018 8H18.5M18.5 1C10.4098 1 3.74401 4.073 2.85151 11.5C2.73601 12.4625 3.53401 13.25 4.50001 13.25H32.5C33.466 13.25 34.264 12.4625 34.1485 11.5C33.256 4.073 26.5903 1 18.5 1ZM9.75176 8H9.75001H9.75176ZM23.7518 6.25H23.75H23.7518Z"
                stroke="#F72D57"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        <div className="full-hover">
          <button className="hover-buttons">
            ...
            >
              <path
                d="M29 34H40.4409C41.1039 34 41.7424 33.7761 42.2284 33.3732C42.7144 32.9703 43.012 32.4182 43.0615 31.8275L46 7"
                stroke="#F72D57"
                stroke-width="2"
                stroke-miterlimit="10"
                stroke-linecap="round"
              ...
              />
              <path
                d="M18.5017 13H18.5M18.5 6C10.4097 6 3.74398 9.073 2.85148 16.5C2.73598 17.4625 3.53398 18.25 4.49998 18.25H32.5C33.466 18.25 34.264 17.4625 34.1485 16.5C33.256 9.073 26.5902 6 18.5 6ZM9.75173 13H9.74998H9.75173ZM23.7517 11.25H23.75H23.7517Z"
                stroke="#F72D57"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
